...
void lv_draw_home(void) {
  ...
  lv_obj_t *buttonBack;
#ifdef ENOFFXY
  lv_obj_t *buttonOffAll;
  lv_obj_t  *buttonOffXY;
#endif
  ...
  buttonBack       = lv_imgbtn_create(scr, NULL);
    ...
    lv_imgbtn_set_src(buttonHomeAll, LV_BTN_STATE_PR, "F:/bmp_clear.bin");
    ...
    lv_imgbtn_set_src(buttonHomeX, LV_BTN_STATE_PR, "F:/bmp_clear.bin");
    ...
    lv_imgbtn_set_src(buttonHomeY, LV_BTN_STATE_PR, "F:/bmp_clear.bin");
    ...
    lv_imgbtn_set_src(buttonHomeZ, LV_BTN_STATE_PR, "F:/bmp_clear.bin");
    ...
    lv_imgbtn_set_src(buttonOffAll, LV_BTN_STATE_PR, "F:/bmp_clear.bin");
    ...
    lv_imgbtn_set_src(buttonOffXY, LV_BTN_STATE_PR, "F:/bmp_clear.bin");
