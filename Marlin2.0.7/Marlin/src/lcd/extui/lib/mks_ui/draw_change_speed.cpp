...
static lv_obj_t *buttonMov;//, *buttonExt;
...
void disp_speed_step() {
  if (uiCfg.stepPrintSpeed == 1) {
    lv_imgbtn_set_src(buttonStep, LV_BTN_STATE_REL, "F:/bmp_speed_slow.bin");
    lv_imgbtn_set_src(buttonStep, LV_BTN_STATE_PR, "F:/bmp_speed_slow.bin");
		if (gCfgItems.multiple_language != 0) {
    ...
    lv_imgbtn_set_src(buttonStep, LV_BTN_STATE_REL, "F:/bmp_speed_normal.bin");
    lv_imgbtn_set_src(buttonStep, LV_BTN_STATE_PR, "F:/bmp_speed_normal.bin");
		if (gCfgItems.multiple_language != 0) {	
    ...
    lv_imgbtn_set_src(buttonStep, LV_BTN_STATE_REL, "F:/bmp_speed_high.bin");
    lv_imgbtn_set_src(buttonStep, LV_BTN_STATE_PR, "F:/bmp_speed_high.bin");
		if (gCfgItems.multiple_language != 0) {
...
void disp_speed_type() {
  switch (uiCfg.speedType) {
    case 1:
      lv_imgbtn_set_src(buttonMov, LV_BTN_STATE_REL, "F:/bmp_extruct_sel.bin");
      lv_imgbtn_set_src(buttonMov, LV_BTN_STATE_PR, "F:/bmp_extruct_sel.bin");
			if (gCfgItems.multiple_language != 0) {			
				lv_label_set_text(labelMov, speed_menu.extrude);
