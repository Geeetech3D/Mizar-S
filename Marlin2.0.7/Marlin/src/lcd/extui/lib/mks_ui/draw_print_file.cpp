...
void disp_gcode_icon(uint8_t file_num)
{
    ...
    lv_obj_set_pos(buttonPageUp, OTHER_BTN_XPIEL * 3 + INTERVAL_V * 7, titleHeight + 20);
    lv_obj_set_pos(buttonPageDown, OTHER_BTN_XPIEL * 3 + INTERVAL_V * 7, titleHeight + OTHER_BTN_YPIEL + INTERVAL_H + 20);
    lv_obj_set_pos(buttonBack, OTHER_BTN_XPIEL * 3 + INTERVAL_V * 7, titleHeight + OTHER_BTN_YPIEL * 2 + INTERVAL_H * 2 + 20);
