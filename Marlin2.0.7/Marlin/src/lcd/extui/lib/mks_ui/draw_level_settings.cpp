...
void lv_draw_level_settings(void) {
  ...
  lv_obj_set_pos(buttonCommand, PARA_UI_POS_X, PARA_UI_POS_Y);//PARA_UI_POS_X, PARA_UI_POS_Y * 2);
  ...
  lv_obj_set_pos(buttonCommandNarrow, PARA_UI_POS_X + PARA_UI_SIZE_X, PARA_UI_POS_Y + PARA_UI_ARROW_V);//PARA_UI_POS_X + PARA_UI_SIZE_X, PARA_UI_POS_Y * 2 + PARA_UI_ARROW_V);
  ...
  lv_ex_line(line2, line_points[0]);

  #if HAS_BED_PROBE

    buttonZoffset = lv_btn_create(scr, NULL);                                 /*Add a button the current screen*/
    lv_obj_set_pos(buttonZoffset, PARA_UI_POS_X, PARA_UI_POS_Y * 2);//PARA_UI_POS_X, PARA_UI_POS_Y * 3);          /*Set its position*/
    ...
    lv_obj_set_pos(buttonZoffsetNarrow, PARA_UI_POS_X + PARA_UI_SIZE_X, PARA_UI_POS_Y * 2 + PARA_UI_ARROW_V);//PARA_UI_POS_X + PARA_UI_SIZE_X, PARA_UI_POS_Y * 3 + PARA_UI_ARROW_V);
    ...
    lv_ex_line(line3, line_points[1]);
