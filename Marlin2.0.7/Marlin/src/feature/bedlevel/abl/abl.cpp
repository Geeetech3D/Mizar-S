...
void print_bilinear_leveling_grid() {
  ...
  print_2d_array(GRID_MAX_POINTS_X, GRID_MAX_POINTS_Y, 3,
	...
	SERIAL_ECHO_MSG("bilinear_grid_spacing: ");
	SERIAL_ECHOPAIR("x ", bilinear_grid_spacing.x);
	SERIAL_ECHOLNPAIR(" y ", bilinear_grid_spacing.y);
	SERIAL_ECHO_MSG("bilinear_start: ");
	SERIAL_ECHOPAIR("x ", bilinear_start.x);
	SERIAL_ECHOLNPAIR(" y ", bilinear_start.y);	
}
