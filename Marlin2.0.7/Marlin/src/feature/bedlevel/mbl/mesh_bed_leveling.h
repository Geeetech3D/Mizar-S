...
#define _MBL_GET_MESH_X(I) mbl.index_to_xpos[I]
#define _MBL_GET_MESH_Y(J) mbl.index_to_ypos[J]
#define MBL_Z_VALUES_ARR mbl.z_values
...
public:
    ...
    static inline xy_int8_t cell_indexes(const xy_pos_t &xy)
    {
    ...
    static inline xy_int8_t probe_indexes(const xy_pos_t &xy)
    {
