...
#elif MB(GT2560_V3_0)
  #include "mega/pins_GT2560_V3.0.h"       			// ATmega2560  
#elif MB(EINSTART_S)
...
#elif MB(GTM32_LCD35_A10)
  #include "stm32f1/pins_GTM32_LCD35_A10.h"      // STM32F1                                env:STM32F103RE
#elif MB(GTM32_LCD35_A30)
  #include "stm32f1/pins_GTM32_LCD35_A30.h"  
#elif MB(GTM32_LCD35_E180)
  #include "stm32f1/pins_GTM32_LCD35_E180.h"      // STM32F1                                env:STM32F103RE
#elif MB(GTM32_REV_B)
