...
struct HeaterWatch {
    ...
    {
        return next_ms && ELAPSED(ms, next_ms);
    }
    inline bool elapsed()
    {
...
typedef struct {
    int16_t raw_min, raw_max, mintemp, maxtemp;
} temp_range_t;
...
#define HOTEND_TEMPS (HOTENDS + ENABLED(TEMP_SENSOR_1_AS_REDUNDANT))
    ...
    {
        return allow_cold_extrude ? false : temp < extrude_min_temp - (TEMP_WINDOW);
    }
...
#else
    FORCE_INLINE static bool tooColdToExtrude(const uint8_t)
    {
        return false;
    }
    FORCE_INLINE static bool targetTooColdToExtrude(const uint8_t)
    {
        return false;
    }
#endif

    FORCE_INLINE static bool hotEnoughToExtrude(const uint8_t e)
    {
        return !tooColdToExtrude(e);
    }
    FORCE_INLINE static bool targetHotEnoughToExtrude(const uint8_t e)
    {
...
#define FANS_LOOP(I) LOOP_L_N(I, FAN_COUNT)
    ...
    static constexpr inline uint8_t fanPercent(const uint8_t speed)
    {
...
#define is_preheating(n) (false)
...
#if ENABLED(SHOW_TEMP_ADC_VALUES)
    FORCE_INLINE static int16_t rawBedTemp()
    {
        return temp_bed.raw;
    }
#endif
    ...
    FORCE_INLINE static int16_t degTargetBed()
    {
        return temp_bed.target;
    }
    FORCE_INLINE static bool isHeatingBed()
    {
        return temp_bed.target > temp_bed.celsius;
    }
    FORCE_INLINE static bool isCoolingBed()
    {
        return temp_bed.target < temp_bed.celsius;
    }
...
#if HAS_TEMP_PROBE
#if ENABLED(SHOW_TEMP_ADC_VALUES)
    FORCE_INLINE static int16_t rawProbeTemp()
    {
        return temp_probe.raw;
    }
#endif
    FORCE_INLINE static float degProbe()
    {
        return temp_probe.celsius;
    }
    FORCE_INLINE static bool isProbeBelowTemp(const float target_temp)
    {
        return temp_probe.celsius < target_temp;
    }
    FORCE_INLINE static bool isProbeAboveTemp(const float target_temp)
    {
        return temp_probe.celsius > target_temp;
    }
...
#if HAS_TEMP_CHAMBER
#if ENABLED(SHOW_TEMP_ADC_VALUES)
    FORCE_INLINE static int16_t rawChamberTemp()
    {
        return temp_chamber.raw;
    }
#endif
    FORCE_INLINE static float degChamber()
    {
        return temp_chamber.celsius;
    }
#if HAS_HEATED_CHAMBER
    FORCE_INLINE static int16_t degTargetChamber()
    {
        return temp_chamber.target;
    }
    FORCE_INLINE static bool isHeatingChamber()
    {
        return temp_chamber.target > temp_chamber.celsius;
    }
    FORCE_INLINE static bool isCoolingChamber()
    {
        return temp_chamber.target < temp_chamber.celsius;
    }
    ...
    FORCE_INLINE static bool is_paused()
    {
        return paused;
    }
#endif
