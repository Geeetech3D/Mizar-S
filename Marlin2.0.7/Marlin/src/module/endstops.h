...
public:
    ...
    static bool	x_manual_limit, y_manual_limit, z_manual_limit;
...
public:
    ...
    FORCE_INLINE static bool abort_enabled()
    {
        return (enabled || TERN0(HAS_BED_PROBE, z_probe_enabled)
                || x_manual_limit || y_manual_limit || z_manual_limit
               );
    }
     ...
     */
    FORCE_INLINE static uint8_t trigger_state()
    {
        return hit_state;
    }
...
#else
    FORCE_INLINE static void validate_homing_move()
    {
        hit_on_purpose();
    }
#endif
    ...
    FORCE_INLINE static void hit_on_purpose()
    {
        hit_state = 0;
    }
