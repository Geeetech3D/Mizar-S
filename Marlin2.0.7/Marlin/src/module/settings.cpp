...
#define EEPROM_OFFSET_POWEROFF 830
...
//
    ...
    //
    {
        _FIELD_TEST(led_onoff_state);
        const bool led_onoff_state = led_onoff_sel;
        EEPROM_WRITE(led_onoff_state);
    }
